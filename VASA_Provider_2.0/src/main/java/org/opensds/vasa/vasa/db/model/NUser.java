...
public class NUser extends BaseData {
    ...
    public String toString() {
        return "NUser [id=" + id + ", username=" + username + ", password=*****" + ", lastLogin=" + lastLogin
                + ", ipAddress=" + ipAddress + ", lastChangePass=" + lastChangePass + ", createdTime=" + createdTime
