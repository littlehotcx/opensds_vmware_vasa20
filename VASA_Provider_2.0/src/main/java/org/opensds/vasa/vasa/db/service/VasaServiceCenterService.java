...
public interface VasaServiceCenterService {

    List<NVasaServiceCenter> queryVasaService(String serviceIp) throws StorageFault;

    List<NVasaServiceCenter> queryCurrentMaster() throws StorageFault;

    void competeMaster(String serviceIp) throws StorageFault;

    void updateMaster(String serviceIp) throws StorageFault;
