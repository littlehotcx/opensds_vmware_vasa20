...
public class VasaOperationServiceImpl extends BaseServiceImpl<VasaOperation> implements VasaOperationService {

    public VasaOperationServiceImpl(BaseDao<VasaOperation> baseDao) {
        super(baseDao);
