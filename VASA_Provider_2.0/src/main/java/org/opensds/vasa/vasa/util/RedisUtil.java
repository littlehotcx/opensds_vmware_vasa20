...
//	public static JedisPool jedisSentinelPool;
    ...
    static {
        ...
        String sentinel_ip = ConfigManager.getInstance().getValue("redis.ip");
        String sentinel_port = ConfigManager.getInstance().getValue("redis.sentinel.port");
...
//		return encrytion.decode(encryptionKey, orgPwd);
    ...
    public static void setStringKeyValue(String key, String value) {
        Jedis jedis = null;
        try {
            jedis = jedisSentinelPool.getResource();
            String result = jedis.set(key, value);

            LOGGER.debug("setStringKeyValue return : " + result);
        } catch (Exception e) {
            LOGGER.error("setStringKeyValue error.", e);
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public static Long setnx(String key, String value) {
        ...
        try {
            ...
            LOGGER.debug("setnx result : " + result);
            return result;
        } catch (Exception e) {
    ...
    public static String getset(String key, String value) {
        ...
        try {
            ...
            LOGGER.debug("getset result : " + result);
            return result;
        } catch (Exception e) {
