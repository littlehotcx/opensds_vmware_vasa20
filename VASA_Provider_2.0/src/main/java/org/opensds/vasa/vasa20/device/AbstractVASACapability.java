...
public abstract class AbstractVASACapability {
    protected ISDKProtocolAdapter protocolAdapter;

    public AbstractVASACapability(ISDKProtocolAdapter protocolAdapter) {
    ...
    public void setProtocolAdapter(ISDKProtocolAdapter protocolAdapter) {
        this.protocolAdapter = protocolAdapter;
    }
