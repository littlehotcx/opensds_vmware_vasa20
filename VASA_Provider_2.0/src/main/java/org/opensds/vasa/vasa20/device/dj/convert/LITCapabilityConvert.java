...
public class LITCapabilityConvert {
    public S2DLIT convertSouth2Model(SLIT southItem) {
        if (null == southItem) {
            return null;
        }
        S2DLIT modelItem = new S2DLIT();
        //common tag
        ...
        //private tag
        modelItem.setIPV4ADDR(southItem.getIPV4ADDR());
