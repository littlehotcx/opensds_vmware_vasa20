...
public class ISCSIInitiatorCapabilityConvert {
    public S2DISCSIInitiator convertSouth2Model(SISCSIInitiator southItem) {
        if (null == southItem) {
            return null;
        }

        S2DISCSIInitiator modelItem = new S2DISCSIInitiator();
        //common tag
