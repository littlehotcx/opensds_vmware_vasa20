...
public class ControllerCapabilityConvert {
    public S2DController convertSouth2Model(SController southItem) {
        if (null == southItem) {
            return null;
        }
        S2DController modelItem = new S2DController();
        //common tag
        ...
        //private tag
        modelItem.setSOFTVER(southItem.getSOFTVER());
