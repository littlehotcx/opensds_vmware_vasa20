...
public class S2DAlarm {
    ...
    public String toString() {
        ...
        return sb.append("[sequence:").append(sequence).append(", eventId:").append(eventID).append(", detail:").append(detail)
                .append(", startTime:").append(date).append("]").toString();
