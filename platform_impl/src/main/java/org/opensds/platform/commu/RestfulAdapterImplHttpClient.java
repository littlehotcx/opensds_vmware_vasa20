...
{
    private static Logger LOGGER = LogManager.getLogger(RestfulAdapterImplHttpClient.class);
...
//        httpClient.getParams().setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 60000);
    ...
    private HttpHost buildHttpHost()
    {
        ...
        {
        	/**
        	 *  FindBugs:DM_BOXED_PRIMITIVE_FOR_PARSING start
        	 *  Modified by wWX315527 2017/02/06
        	 */
     ...
     */
    @Override
    public synchronized Object syncSendMessage(Object reqMessage, String serviceApiName, String resObjClass)
...
//            LOGGER.info("-----------------------------StatusLine:" + respStatusLine);
