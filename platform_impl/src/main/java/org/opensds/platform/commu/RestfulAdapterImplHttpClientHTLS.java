...
{
    private static Logger LOGGER = LogManager.getLogger(RestfulAdapterImplHttpClientHTLS.class);
    ...
    public RestfulAdapterImplHttpClientHTLS(String serverUrl)
    {
        ...
        if (serverUrl.startsWith(ESDKConstant.PROTOCOL_ADAPTER_TYPE_HTTPS))
        {
            try
            {
                 ...
                 */
                URL server = new URL(PathUtils.UrlPathFormatWithEncode(serverUrl, "UTF-8"));
